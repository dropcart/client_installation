...
?>
	<div class="col-md-2">
		...
		<div>
			<a href="<?= route('edit_shopping_bag', [$product['id'], 1]); ?>" class="btn btn-lg btn-block btn-primary order-link"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;Bestellen</a>
		</div>
	</div>
<?php
endif;
