...
<head>
    ...
    <!-- STYLES -->
@include('DefaultPs::dynamic.styles')

@stack('styles')

<!-- SCRIPTS -->
    @include('DefaultPs::dynamic.pre-js')
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-5">
            <form class="form-horizontal search-products" method="get" action="<?= route('products_by_query', ['locale' => loc()]); ?>">
        ...
        <div class="col-md-4">
            @if(env('MULTILINGUAL', FALSE))
                <div class="float-right" style="padding-top: 10px; padding-left: 10px;">
                    @include('DefaultPs::blocks.language-switcher')
                </div>
            @endif
            <div class="push-right">
                @include("DefaultPs::blocks.pages-menu")
                <div class="float-clear"></div>

                <div id="cart">
                    @include('DefaultPs::blocks.shopping-bag')
                </div>
    ...
    <div class="masthead">
        @include('DefaultPs::blocks.main-menu')
    </div>